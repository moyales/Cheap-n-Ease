...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?php echo base_url(); ?>project_images/cne-home-logo.png">
    </head>
    <body id="login">
        <header>
            ...
            <div class="navbar">
                <ul>
                    <li><a href="http://students.stevens.edu/cne/login">Home</a></li>
                    <li><a href="http://students.stevens.edu/cne/login_whatIsCNE">What is C&E?</a></li>
                    <li><a href="http://students.stevens.edu/cne/login_about">About Us</a></li>
                    <li id="signup"><a href="http://students.stevens.edu/cne/signup" id="signup-bg">Sign Up</a></li>
                </ul>
            </div>
        </header>