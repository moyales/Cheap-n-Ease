            ...
            <div class="main-navbar">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo base_url(); ?>main/main_income">Income</a>
                        <a href="<?php echo base_url(); ?>main/main_expenses">Expenses</a>
                        <a href="<?php echo base_url(); ?>main/main_goals">Goals</a>
                        <a href="<?php echo base_url(); ?>main/main_forecast">Forecast</a>
                    </div>
                </div>
                <div class="dropdown">
            ...
            <div class="right">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="#">Profile</a>
                        <a href="#">Settings</a>
                        <a href="<?php echo base_url(); ?>login">Log Off</a>
                    </div>
                </div>                    
            </div>
